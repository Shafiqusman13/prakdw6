const apiKey = '1bbf392f3d574a7498f23111241510';  // Ganti dengan API key yang valid
const city = 'Jakarta';
...
fetch(apiURL)
    ...
    .catch(error => {
        ...
        document.getElementById('current-weather').innerHTML = '<p>Terjadi kesalahan saat mengambil data cuaca. Mohon coba lagi nanti.</p>';
